...
export const COMMAND_GROUPS: CommandGroup[] = [
  {
    ...
    commands: [
      {
        usage: "events [list|view|create|edit|draft|cancel|uncancel] [<id>] [flags]",
        summary:
        ...
        examples: [
          ...
          "squadquest-axi events cancel <id>     # tells guests it is OFF",
...
export function renderCommandHelp(name: string): string | null {
  ...
  if (name === "events") {
    lines.push(
      "",
      "edit vs cancel: `edit` fixes a record for an event that IS still happening.",
      "`cancel` is a message to your guests that it is NOT. Use edit for mistakes.",
    );
  }
