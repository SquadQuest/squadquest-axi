...
- [ ] Pushing develop opens a Release PR with a generated changelog
...
- [ ] `npm pack` contains `dist`, `LICENSE`, `README.md` and nothing else
- [ ] The packed tarball contains no credentials, fixtures, or `.env`
